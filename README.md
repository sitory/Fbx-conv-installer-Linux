...
3. Install with your package manager: ```libpng-dev zlib1g-dev sed git wget make gcc lib32stdc++6 lib32gcc1 lib32z1``` (lib32stdc++6 lib32gcc1 lib32z1 only necessary for 64-bit)
