...
1. ```./fbx-conv.sh``` or ```libgdx-fbxconv-gui.sh``` (if you installed the gui) a script that run fbx-conv, but export the library path to current directory before doing it, you can use arguments.
